        ...
        <div className="home-hero__inner container">
          <div className="home-hero__text reveal">
            ...
            <p className="home-hero__standfirst">
              A revista de tecnologia e cultura digital angolana. Inteligência
              artificial, startups, dados abertos e a transformação que está a
              redefinir o continente.
            </p>
          ...
          <ul className="home-archive__list reveal" role="list">
            {EDITIONS.slice(1).map((ed) => (
              <li key={ed.id} className="home-archive__row">
                <Link
                  to={`/edition/${ed.id}`}
                  className="home-archive__row-inner"
                >
                  ...
                  <span className="home-archive__row-body">
                    ...
                    <span className="home-archive__row-excerpt">
                      {ed.excerpt}
                    </span>
                  </span>
                  <svg
                    className="home-archive__row-arrow"
                    width="18"
                    height="18"
                    fill="none"
                    stroke="currentColor"
        ...
        <div className="home-about__inner container">
          <div className="home-about__content reveal">
            ...
            <p className="home-about__text">
              ...
              tecnológica, inovação e pensamento digital. Acreditamos que o
              futuro não é algo que se espera, é algo que se constrói e molda.
            </p>
            <p className="home-about__text">
              Como a mais destacada publicação do género no nosso mercado, temos
              como missão documentar e incentivar os saltos de disrupção no
              continente, unindo líderes de pensamento a talentos emergentes.
            </p>
            <p className="home-about__provenance">2ª edição · Luanda, Angola</p>
          </div>
      ...
      <section className="home-close">
        <div className="home-close__inner container reveal">
          <p className="home-close__text">
            O futuro não é algo que se espera. É algo que se constrói.
          </p>
