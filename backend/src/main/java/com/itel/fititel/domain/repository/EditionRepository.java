...
public interface EditionRepository extends JpaRepository<Edition, Long> {
    ...
    Page<Edition> findAllByDeletedAtIsNullAndFreeIsTrue(Pageable pageable);
    Page<Edition> findAllByReleaseDateAndDeletedAtIsNull(LocalDate releaseDate, Pageable pageable);
}